...
!define SCDIR "$SMPROGRAMS\OpenHRI\voice${PACKAGE_VERSION}"
...
LicenseLangString MUILicense_Julius ${LANG_ENGLISH} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\dictation-kit-v4.2.3-win\doc\LICENSE.txt"
LicenseLangString MUILicense_Julius ${LANG_JAPANESE} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\dictation-kit-v4.2.3-win\doc\LICENSE.txt"
...
LicenseLangString MUILicense_Male ${LANG_ENGLISH} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\hts_voice_nitech_jp_atr503_m001-1.05\COPYING"
LicenseLangString MUILicense_Male ${LANG_JAPANESE} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\hts_voice_nitech_jp_atr503_m001-1.05\COPYING"
LicenseLangString MUILicense_Mei ${LANG_ENGLISH} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\MMDAgent_Example-1.4\Voice\mei\COPYRIGHT.txt"
LicenseLangString MUILicense_Mei ${LANG_JAPANESE} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\MMDAgent_Example-1.4\Voice\mei\COPYRIGHT.txt"
LicenseLangString MUILicense_Festival ${LANG_ENGLISH} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\festival\COPYING"
LicenseLangString MUILicense_Festival ${LANG_JAPANESE} "C:\Program Files (x86)\OpenHRIVoice\3rdparty\festival\COPYING"
...
;  File "/oname=ChangeLog.txt" "${TOP_SRCDIR}\ChangeLog"
  ...
  ; sox sound exchange
  !insertmacro Download "http://prdownloads.sourceforge.net/sox/sox-14.4.2-win32.zip" "sox-14.4.2-win32.zip"
  ZipDLL::extractall "$INSTDIR\downloads\sox-14.4.2-win32.zip" "$INSTDIR\3rdparty"

  ; julius for windows and acoustic model for japansese
;  !insertmacro Download "http://prdownloads.sourceforge.jp/julius/59050/dictation-kit-v4.2.3-win.zip" "julius-dictation-kit-v4.2.3-win.zip"
  !insertmacro Download "http://sourceforge.jp/frs/redir.php?m=iij&f=%2Fjulius%2F59050%2Fdictation-kit-v4.2.3-win.zip" "julius-dictation-kit-v4.2.3-win.zip"
  ;harumi  !insertmacro Download "http://sourceforge.jp/frs/redir.php?m=iij&f=%2Fjulius%2F44943%2Fdictation-kit-v4.2.3-win.zip" "julius-dictation-kit-v4.2.3-win.zip"
  ZipDLL::extractall "$INSTDIR\downloads\julius-dictation-kit-v4.2.3-win.zip" "$INSTDIR\3rdparty"
  ...
  ;harumi   !insertmacro Download "http://prdownloads.sourceforge.net/open-jtalk/open_jtalk_dic_utf_8-1.04.tar.gz"  "open_jtalk_dic_utf_8-1.04.tar.gz"
  ;harumi   untgz::extract -d "$INSTDIR\3rdparty" "$INSTDIR\downloads\open_jtalk_dic_utf_8-1.04.tar.gz"
  !insertmacro Download "http://openrtc.org/OpenHRI/build/dic_utf_8.zip"  "dic_utf_8.zip"
  ZipDLL::extractall "$INSTDIR\downloads\dic_utf_8.zip" "$INSTDIR\3rdparty\"

  ; Open JTalk acoustic model
  !insertmacro Download "http://prdownloads.sourceforge.net/open-jtalk/hts_voice_nitech_jp_atr503_m001-1.05.tar.gz"  "hts_voice_nitech_jp_atr503_m001-1.05.tar.gz"
  untgz::extract -d "$INSTDIR\3rdparty" "$INSTDIR\downloads\hts_voice_nitech_jp_atr503_m001-1.05.tar.gz"

  ; MMDAgent model file
  !insertmacro Download "http://prdownloads.sourceforge.net/mmdagent/MMDAgent_Example-1.4.zip"  "MMDAgent_Example-1.4.zip"
  ZipDLL::extractall "$INSTDIR\downloads\MMDAgent_Example-1.4.zip" "$INSTDIR\3rdparty"

  ; Festival
  !insertmacro Download "http://prdownloads.sourceforge.net/e-guidedog/festival-1.96.03-win.zip"  "festival-1.96.03-win.zip"
  ZipDLL::extractall "$INSTDIR\downloads\festival-1.96.03-win.zip" "$INSTDIR\3rdparty\"
